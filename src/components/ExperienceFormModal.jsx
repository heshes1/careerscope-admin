...
export default function ExperienceFormModal({ initial, onClose, onSave }){
  const [form, setForm] = useState({ id:'', title:'', org:'', category:'', startDate:'', endDate:'', tags:'' })

  useEffect(()=>{ if(initial) setForm({ ...initial, tags: (initial.tags || []).join(', ') }) },[initial])
      ...
      <div className="modal card">
        ...
        <form onSubmit={submit}>
          <div className="form-row">
            ...
            <input placeholder="Organization" value={form.org} onChange={e=>update('org', e.target.value)} required />
          </div>
          <div className="form-row">
